...
| Email capture page exists | [ ] | User reaches email page inside the canonical flow after the start/assessment steps. |
...
| Mock paywall page exists | [ ] | User reaches mock paywall after email auth and the deterministic result page. |
...
| Requirement | Status | How |
| --- | --- | --- |
| MVP demonstrates marketing funnel flow | [ ] | Landing / quiz start -> assessment -> email/auth -> result -> mock paywall works. |
